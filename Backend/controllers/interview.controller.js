...
export const generateQuestion = async (req, res) => {
    try {
        ...
        if (!role || !experience || !mode) {
            return res.status(400).json({ message: "Role, Experience and Mode are required to continue." })
        }
        ...
        const messages = [
            {
                ...
                content: `
                    ...
                    Generate exactly 5 good quality interview questions.
                    Strict Rules:
        ...
        const interview = await Interview.create({
            userId: user._id,
            role, experience, mode, resumeText: safeResume,
...
export const submitAnswer = async (req, res) => {
    try {
        ...
        if (!answer) {
            question.score = 0;
            question.feedback = "You did not submit your answer.";
            question.answer = "";
