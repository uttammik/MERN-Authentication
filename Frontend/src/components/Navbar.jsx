        ...
        <div className='flex items-center gap-6 relative'>
            <div className='relative'>
                <button onClick={()=>{
                    ...
                    {showCreditPopup && (
                        <div className='absolute right-[-50px] top-[50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
            ...
            <div className='relative'>
                ...
                {showUserPopup && (
                    <div className='absolute right-0 top-[50px] mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
