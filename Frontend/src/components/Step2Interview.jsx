    ...
    useEffect(()=>{
        ...
        const runIntro = async()=>{
           if(isIntroPhase){
              ...
              await speakText(
                `I'll ask you a few questions. Take your time to answer them naturally. Let's begin`
              );
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
            ...
            {subtitle && (
              <div className='w-full max-w-md bg-gray-50 border border-gray-200 rounded-xl p-4 shadow-sm'>
                <p className='test-gray-700 text-sm sm:text-base font-medium leading-relaxed text-center'>{subtitle}</p>
              </div>
            )}
            ...
            <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
              ...
              <div className='flex justify-center'>
                <Timer
                  timeLeft={timeLeft} totalTime={currentQuestion?.timeLeft || 60}
                />
              </div>
