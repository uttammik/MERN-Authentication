          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index} 
                  ...
                  ${index===0 ? "rotate-[0deg]" : ""}
                  ${index===1 ? "rotate-[0deg] md:-mt-1 shadow-xl" : ""}
                  ${index===2 ? "rotate-[0deg]" : ""}
                  `}>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                      ...
                      desc : "Detailed strengths, weaknesses, and imporvement insights."
                  },
                  {
                      image : analyticsImg,
                      icon : <BsBarChart size={20}/>,
                      title : "History & Analytics",
                      desc : "Track progress with performance gaphs and topic analysis."
                  }
                ].map((item,index)=>(
                  <motion.div 
                    initial = {{opacity:0, y:30}}
